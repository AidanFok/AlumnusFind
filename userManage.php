...
<div class="bs-example" data-example-id="simple-horizontal-form">
	...
	<legend>添加用户</legend>
      <div class="form-group">
        ...
        <div class="col-sm-5">
       <input type="text" name="u_id" class="form-control" placeholder="ID"> <font color="red"> *</font><br/>
        </div>
      </div>
      <div class="form-group">
        <label class="col-sm-1 control-label">密码</label>
        <div class="col-sm-5">
       <input type="password" name="u_pwd" class="form-control" placeholder="密码"> <font color="red"> *</font><br/>
        </div>
      </div>
      <div class="form-group">
...
<div class="container">
<div class="bs-example" data-example-id="simple-horizontal-form">
	<form name="input" action="del_user.php" method="post">
	...
	<legend>删除用户</legend>
      <div class="form-group">
        <label class="col-sm-1 control-label">ID</label>
        <div class="col-sm-5">
       <input type="text" name="u_id" class="form-control" placeholder="ID"> <br/>
        </div>
      </div>
