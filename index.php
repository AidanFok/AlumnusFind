...
<div class="typrography">
	<div class="container">
	<div class="page">
		<h3 class="typo1">用户登录</h3>
	<!--Forms-->
	<div class="page-header">
      </div>
  <div class="bs-example" data-example-id="simple-horizontal-form">
    <form class="form-horizontal" name="input" action="user_login_check.php" method="post">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="password" name="u_pwd" class="form-control" placeholder="password">
        </div>
      </div>
      <div class="form-group">
